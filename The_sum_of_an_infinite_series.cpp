...
предназначенное для приближённого вычисления суммы бесконечного числового ряда, 
выбранного согласно номеру варианта. Входные данные: параметр x и параметр α, 
характеризующий точность вычисления ряда. Выходные данные: номер итерации (n), 
последний просуммированный член ряда (an), текущая частичная сумма (Sn), 
точность вычисления заданной текущей частичной суммы (αn). */
#include <iostream>
#include <cmath>
using namespace std;
